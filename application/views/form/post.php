...
<?php echo form_open_multipart('post/form', array('id'=>'postNews')) ?>
    <div class=<?=$form_group?>>
        <?php echo form_label('Tiêu Đề'.$required.':','title',array('class'=>$label_class)) ?>
        <?php
        $data= array(
            'name' => 'title',
            'id'=>'title',
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Tên Người Liên Hệ'.$required.':','username',array('class'=>$label_class)) ?>
        <?php
        $data = array(
            'name'=>'username',
            'id'=>'username',
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Ngày Hết Hạn'.$required.':','',array('class'=>$label_class)) ?>
        <?php
        $data = array(
            'name'=>'datepicker',
            'id'=>'datepicker',
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Số Điện Thoại'.$required.':','phone',array('class'=>$label_class)) ?>
        <?php
        $data = array(
            'name'=>'phone',
            'id'=>'phone',
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Email:','email',array('class'=>$label_class)) ?>
        <?php
        $data = array(
            'name'=>'email',
            'id'=>'email',
    ...
    <div class=<?=$form_group?> style="margin-top: 23px">
        <?php echo form_label('Địa Chỉ'.$required.':','',array('class'=>$label_class)) ?>
        <?php
        $data = array(
            'name'=>'subAddress',
            'id'=>'subAddress',
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Chuyên Mục'.$required.':','',array('class'=>$label_class)) ?>
    ...
    <div class=<?=$form_group?>>
        <?php
        echo form_label('Diện Tích'.$required.':','area',array('class'=>$label_class));
        $data = array(
            'type' => 'number',
            'name'=>'area',
            'id'=>'area',
    ...
    <div class=<?=$form_group?>>
        <?php
        echo form_label('Giá Phòng'.$required.':','price',array('class'=>$label_class));
        $data = array(
            'type' => 'number',
            'name'=>'price',
            'id'=>'price',
    ...
    <div class="form-group smallIssue">
        <label class=<?=$label_class?> style="top: -60px">Các Tiện Ích Khác:</label>
    ...
    <div class="form-group smallIssue">
        <label class=<?=$label_class?> style="top: -20px">Yêu Cầu Đối Với Người Thuê:</label>
    ...
    <div class=<?=$form_group?>>
        <?php echo form_label('Nội Dung'.$required.':', 'content', array('class'=>$label_class)) ?>
